...
public class Bear extends Animal implements Predator {
    ...
    private static final AnimalType animalType = AnimalType.BEAR;
    private static Map<AnimalType, Integer> edibleMap = new HashMap<>();


    public static void initInhabitant(double newWeight, int newMaxNumberOnCell, int newSpeed, double newMaxAppetite) {
        maxWeight = newWeight;
    ...
    public Bear(AnimalType type, int y, int x) {
        super(type, y, x);
    }
